...
function getValidReactChildren(children2) {
  return React9.Children.toArray(children2).filter((child) => React9.isValidElement(child));
}
...
function createGrid(options = {}) {
  ...
  const Grid2 = React27.forwardRef(function Grid3(inProps, ref) {
    ...
    let result = (0, import_jsx_runtime11.jsx)(GridRoot, _extends({
      ...
      children: React27.Children.map(children2, (child) => {
...
function joinChildren(children2, separator) {
  const childrenArray = React28.Children.toArray(children2).filter(Boolean);
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-72QREYDA.js.map
